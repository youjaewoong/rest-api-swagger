...
public class EgovStringUtil {
    ...
    public static String remove(String str, char remove) {
        ...
        if (isEmpty(str) || str.indexOf(remove) == -1) {
            ...
            returnValue =  new String(chars, 0, pos);
        }
        return returnValue;
    }
    ...
    public static int indexOf(String str, String searchStr) {
        ...
        if (str == null || searchStr == null) {
            ...
            returnValue = str.indexOf(searchStr);
        }
        return returnValue;
    }
	...
	//if (src != null && src.getClass().getName().equals("java.math.BigDecimal")) {
        ...
        if (src != null && src instanceof java.math.BigDecimal) {
            returnValue =  ((BigDecimal)src).toString();
    	}
    
    	if (src == null || src.equals("null")) {
    	    returnValue =  "";
    	} else {
    	    returnValue =  ((String)src).trim();
    	}
    	return returnValue;
    }
    ...
    public static int zeroConvert(Object src) {
    	...
    	if (src == null || src.equals("null")) {
    	    ...
    	    returnValue = Integer.parseInt(((String)src).trim());
    	}
    	return returnValue ;
    }
    ...
    public static int zeroConvert(String src) {
    	...
    	if (src == null || src.equals("null") || "".equals(src) || " ".equals(src)) {
    	    ...
    	    returnValue = Integer.parseInt(src.trim());
    	}
    	return returnValue;
    }
    ...
    public static String removeWhitespace(String str) {
        ...
        if (isEmpty(str)) {
            ...
            if (count == sz) {
                ...
                returnValue = new String(chs, 0, count);
            }
        }
        return returnValue;
    }
    ...
    public static String stripStart(String str, String stripChars) {
        ...
        if (str == null || (strLen) == 0) {
            ...
            returnValue = str.substring(start); 
        }
        return returnValue;
    }
    ...
    public static String stripEnd(String str, String stripChars) {
        ...
        if (str == null || end == 0) {
            ...
            if (stripChars == null) {
                ...
                returnValue = str.substring(0, end);
            } else if (stripChars.length() == 0) {
                returnValue = str;
            } else {
    ...
    public static String strip(String str, String stripChars) {
        ...
        if (isEmpty(str)) {
    	    ...
    	    returnValue = stripEnd(srcStr, stripChars);
    	}
        return returnValue;
    }
...
/**
	...
	public static String addMinusChar(String date) {
	    String returnValue = "";
	    if(date.length() == 8)
	        returnValue = date.substring(0,4).concat("-").concat(date.substring(4,6)).concat("-").concat(date.substring(6,8));
		else returnValue = "";
